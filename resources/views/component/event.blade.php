  ...
  <div class="container">
    ...
    <div class="detail">
      <div class="content">
        ...
        <div class="line"></div>
        <div class="btn btn__primary">View Event Details</div>
      </div>
      <!-- Swiper -->
      <div class="swiper mySwiper">
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            <img src="{{{ asset('assets/image-swiper.png') }}}" alt="">
          </div>
          <div class="swiper-slide">
            <img src="{{{ asset('assets/mangrove-forest.png') }}}" alt="">
          </div>
        </div>
